...
(* type rec_flag          = [%import: Vernacexpr.rec_flag          ] [@@deriving sexp,yojson,python] *)
...
(* type inductive_flag    = [%import: Vernacexpr.inductive_flag    ] [@@deriving sexp,yojson,python] *)
...
type onlyparsing_flag  = [%import: Vernacexpr.onlyparsing_flag  ] [@@deriving sexp,yojson,python]
